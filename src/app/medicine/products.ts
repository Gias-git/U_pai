export const products = Array.from({ length: 40 }, (_, i) => {
  const baseNames = [
    "Ceevit", "Paracetamol", "Napa Extra", "Aspirin", "Zimax", "Seclo",
    "Antacid", "Histacin", "Nexum", "Monas", "Maxpro", "Losectil"
  ];
  ...
  const deliveryOptions = [
    "6-12 Hours", "12-24 Hours", "24 Hours", "48 Hours", "72 Hours", "1-2 Days"
  ];
